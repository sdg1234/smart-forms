...
function check(testtext) {
  ...
  success: function(result){
      ...
      if(requesttype=="personal" && result!= wrongtexts){
          let text = "your name is " + result[0].name + " your age is " + result[0].age + " and your address is " + result[0].address + " your marital status is "+result[0].martialstatus;
          dynamic(text, "dynamic-result")
          formSpeaking(text)
      }
      
      if(requesttype=="policy" && result!= wrongtexts){
          let text = "The Policy name is " + result[0].policyname;
          dynamic(text, "dynamic-result")
          formSpeaking(text)
      }
  },
